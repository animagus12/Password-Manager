...
root.iconbitmap(
    'C:/Users/subhr/OneDrive/Documents/Programs/Python/password_manager/lock.ico')
...
def checker():
    ...
    def add_password():
        ...
        generate_button = Button(
            main, text="Generate Password", command=password_generator)
        generate_button.grid(row=3, column=2)

    # Main Button to Add Entries
    add_button = Button(
        main, text="+", font=("Helvetica", 24), command=add_password)
