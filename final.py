...
# First Window where you give the master key
root = Tk()
root.title('Password Manager')
root.iconbitmap('C:/Users/subhr/OneDrive/Documents/Programs/Python/password_manager/lock.ico')
root.geometry('400x400')

# global bg_label
# bg = PhotoImage(file= "C:/Users/subhr/OneDrive/Documents/Programs/Python/password_manager/lockscreen.png")
...
# Check the master key and open Home
def checker():
    mk = master_key.get()
    if mk == master_pass:
        root.destroy()
    
    #Creation of the Home Window
    main = Tk()
    main.title('Home')
    main.iconbitmap('C:/Users/subhr/OneDrive/Documents/Programs/Python/password_manager/lock.ico')
    ...
    # Clearing Screen after inputs are added to the Database
    def clear():
    ...
    # Editing an Entry to the Database
    def edit_db():
        # Creation of Editing page
        edit = Tk()
        edit.title('Edit')
        edit.iconbitmap('C:/Users/subhr/OneDrive/Documents/Programs/Python/password_manager/lock.ico')
    ...
    # Fucntion to Delete n Entry in Database
    def delete_db():
    ...
    # Creation of boxes and labels for Data Entry
    def add_password():
    ...
    # Main Button to Add Entries
    add_button = Button(main, text= "+", font= ("Helvetica", 24), command= add_password)
    add_button.grid(row= 0, column= 0)

# Entry box for Master Password
global master_key

master_key = Entry(root, show = '*')
master_key.pack()

# Button to check Master password
master_key_btn = Button(root, text= "Log in", command= checker)
master_key_btn.pack()
